...
\section{Analysis}
\subsection{Ranking}
The final ranking is given at figure~\ref{fig:ranking}. We can see that the OVH alternative is better than the other ones according to the final ranking. The second and third alternative in the total ordered ranking are respectively Amazon AWS and Google App Engine. With the figure~\ref{fig:contrib}, it can be seen that the alternatives OVH and Google App Engine are well ranked because of the cost criteria. On the contrary, the Amazon AWS solution is well ranked due to his relatively good evaluation in a majority of criteria, this tendency is showed at the figure~\ref{fig:spider}.\\
